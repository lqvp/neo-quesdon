...
export default function GithubRepoLink() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <Link href="https://github.com/lqvp/neo-quesdon" className="flex items-center gap-2 opacity-70">
        <div>
          <svg
            width="15"
            height="15"
        ...
        <div className="text-xs underline font-bold">GitHub Fork (lqvp)</div>
      </Link>
